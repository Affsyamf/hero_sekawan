...
export default function GuideImportColorKitchenModal({ isOpen, onClose }) {
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                >
                  Lokasi:{" "}
                  <strong>Menu Color Kitchen → Button "Import from Excel"</strong>
                </p>
                <p className="text-xs" style={{ color: colors.text.secondary }}>
                  Setelah semua data master berhasil di-import, Anda dapat
                  melakukan import transaksi pembelian.{" "}
                  <strong>
                    Format: Sheet "TEMPLATE QTY" with OPJ, DESIGN, JENIS KAIN, ROLL, and TGL columns.
                  </strong>
                </p>
              </div>
            </div>
