...
export default function GuideImportStockMovementModal({ isOpen, onClose }) {
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                >
                  Lokasi:{" "}
                  <strong>Menu Stock Movement → Button "Import from Excel"</strong>
                </p>
                <p className="text-xs" style={{ color: colors.text.secondary }}>
                  Setelah semua data master berhasil di-import, Anda dapat
                  melakukan import transaksi pembelian.{" "}
                  <strong>
                    Format:</strong> Sheet "CHEMICAL" with NOBUKTI, TANGGAL, QTY, NAMABRG columns
