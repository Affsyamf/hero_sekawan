            ...
            <div className="space-y-2 text-sm text-blue-800">
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                <div>
                  ...
                  <p className="text-xs">
                    Total nilai pembelian bahan baku (Product) dari supplier ke
                    gudang
                  </p>
                </div>
                <div>
              ...
              <div className="pt-2 mt-3 border-t border-blue-200">
                <p className="text-xs text-blue-700">
                  <strong>Catatan:</strong> Data saat ini menggunakan MOCK DATA
                  untuk development. Integrasi dengan backend API akan dilakukan
